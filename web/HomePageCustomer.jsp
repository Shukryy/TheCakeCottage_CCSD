<%-- 
    ...
    Created on : 27 Oct 2024, 11:01:42 pm
    Author     : User
--%>
                            ...
                            <div class="header__top__inner">
                                ...
                                <div class="header__top__right">
                                    ...
                                    <div class="header__top__right__cart">
                                        <a href="#" onclick="location.href = '<%=request.getContextPath()%>/CustomerController?action=signout'" value="Logout">
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-8">
                                <div class="hero__text">
                                    <h2>Life is too short to say no to cake</h2>
                                    <span class="flaticon-029-cupcake-3 mr-3"></span>
                                    <span class="flaticon-034-chocolate-roll mr-3"></span>
                                    <span class="flaticon-030-cupcake-2 mr-3"></span>
                                    <span class="flaticon-006-macarons mr-3"></span>
                                    <span class="flaticon-005-pancake ml-1"></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <%
                        ...
                        int count = 0; // Counter to limit the number of products displayed

                        for (Product product : listProduct) {
                            if (count >= 8) {
                                break; // Stop the loop after 8 products
                            }%>
                        ...
                        <div class="product__item">
                            <div class="product__item__pic">
                                ...
                                <div class="product__label">
                                    <span><%=product.getProductCategory()%></span>
                                </div>
                            </div>
                            <div class="product__item__text">
                                <h6><a href="#"><%=product.getProductName()%></a></h6>
                                <div class="product__item__price">RM <%= String.format("%.2f", product.getProductPrice())%></div>
                                <div class="cart_add">
                                    <a href="ShopCustomer.jsp" class="add-to-cart">
                                        Add to cart
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="footer__about">
                            <div class="footer__logo">
                                <a href="HomePageCustomer.jsp"><img src="img/footer1-logo.png" alt="" width="200" height="79"></a>
                            </div>
