<%-- 
    Document   : index
    Created on : 13 Oct 2024, 6:24:07 pm
    Author     : User
--%>
        ...
        <header class="header">
            <div class="header__top">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="header__top__inner" style="position: relative;">
                        ...
                        <div class="team__item set-bg" data-setbg="img/team/shuk123.jpg">
                            <div class="team__item__text">
                                ...
                                <div class="team__item__social">
                                    ...
                                    <a href="https://www.instagram.com/chukiiy/" target="blank"><i class="fa fa-instagram"></i></a>
