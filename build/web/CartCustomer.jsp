<%-- 
    Document   : CartCustomer
    Created on : 27 Oct 2024, 11:10:51 pm
    Author     : User
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <section class="shopping-cart spad">
            <div class="container">
                <div style="position: relative; display: inline-block; top: -80px;">
                    <a href="ShopCustomer.jsp" style="display: flex; align-items: center;">
                        <img src="img/icon/back.png" alt="Back" style="width: 60px; height: 60px; object-fit: contain;">
                    </a>
                </div>
